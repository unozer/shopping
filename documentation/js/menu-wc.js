                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/KeyLoggerComponent.html" data-type="entity-link" >KeyLoggerComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/CopyrightDirective.html" data-type="entity-link" >CopyrightDirective</a>
                                </li>
                                <li class="link">
                                    <a href="directives/PriceMaximumDirective.html" data-type="entity-link" >PriceMaximumDirective</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
